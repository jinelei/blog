...
public enum BlogExceptionEnum {
    ...
    CHECK_FAILED(HttpStatus.BAD_REQUEST.value(), CHECK_FAILED_STR, 900007, PARAM_PLACEHOLDER),
    NOT_ALLOW_UPDATE_FIELD(HttpStatus.BAD_REQUEST.value(), NOT_ALLOW_UPDATE_FIELD_STR, 900007, PARAM_PLACEHOLDER),
    /**
     * 用户错误码
     */
    ...
    UNAUTHORIZED(HttpStatus.UNAUTHORIZED.value(), UNAUTHORIZED_STR, 800008, PARAM_PLACEHOLDER),
    ...
    UNAUTHORIZED_USER(HttpStatus.UNAUTHORIZED.value(), UNAUTHORIZED_USER_STR, 800128, PARAM_PLACEHOLDER),
    UNAUTHORIZED_GROUP(HttpStatus.UNAUTHORIZED.value(), UNAUTHORIZED_GROUP_STR, 800256, PARAM_PLACEHOLDER),
