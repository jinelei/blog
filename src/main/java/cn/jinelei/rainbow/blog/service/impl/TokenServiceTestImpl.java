...
public class TokenServiceTestImpl implements TokenService {
    ...
    @Override
    public boolean checkToken(TokenEntity model, Authorization authorization) throws BlogException {
...
//            throw new BlogException(UserExceptionEnum.UNAUTHORIZED_USER);
//        }
//        if (user.getUserPrivilege().getCode() < authorization.userType()) {
//            throw new BlogException(UserExceptionEnum.UNAUTHORIZED_GROUP);
//        }
//        return result;
        return true;
    }
    ...
    @Override
    public TokenEntity getToken(String authentication) throws BlogException {
    ...
    @Override
    public void deleteToken(UserEntity userEntity) throws BlogException {
